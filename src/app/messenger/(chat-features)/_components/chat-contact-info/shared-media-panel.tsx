...
import SharedMediaDirectory from "@/app/messenger/(chat-features)/_components/shared-media-directory";
...
const SharedMediaPanel = ({ conversationId, onBack }: SharedMediaPanelProps) => (
	<SidePanel>
		<SidePanelHeader>
			<div className="flex w-full items-center space-x-3">
				...
				<h1 className="text-base font-semibold leading-none">Shared Media</h1>
			</div>
		</SidePanelHeader>
		<SidePanelContent className="h-full p-0">
			<SharedMediaDirectory conversationId={conversationId} />
		</SidePanelContent>
	</SidePanel>
);
