...
import LoadingSkeleton from "@/app/messenger/(chat-features)/_components/online-friends-list/loading-skeleton";
import OnlineFriendItem from "@/app/messenger/(chat-features)/_components/online-friends-list/online-friend-item";
